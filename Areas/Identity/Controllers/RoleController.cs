...
namespace ClinicManagement.Areas.Identity.Controllers
{
    ...
    public class RoleController : Controller
    {
        ...
        public RoleController(ILogger<RoleController> logger, RoleManager<IdentityRole> roleManager, ClinicManagementDbContext context, UserManager<AppUser> userManager)
        {
            _logger = logger;
