...
using ClinicManagement.Areas.Identity.Models.ManageViewModels;
using ClinicManagement.Areas.Identity.Models.RoleViewModels;
using ClinicManagement.Areas.Identity.Models.UserViewModels;
...
namespace ClinicManagement.Areas.Identity.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        public UserController(ILogger<RoleController> logger, RoleManager<IdentityRole> roleManager, ClinicManagementDbContext context, UserManager<AppUser> userManager)
        {
            _logger = logger;
