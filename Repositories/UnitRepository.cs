...
namespace ClinicManagement.Repositories
{
    ...
    {
        private readonly ClinicManagementDbContext _context; // for connecting to efcore.
        public UnitRepository(ClinicManagementDbContext context) // will be passed by dependency injection.
        {
            _context = context;
        }
